...
START_HANDLER(get_szyc, HTTP_GET, "/api/1.0/szyc.json", http_request, http_response, socket)
{
    IpcamIAjax *iajax;
...
START_HANDLER(put_szyc, HTTP_PUT, "/api/1.0/szyc.json", http_request, http_response, socket)
{
    ipcam_http_request_handler_do_put_action(put_szyc,
                                             http_request,
                                             http_response,
                                             socket,
                                             "set_szyc");
